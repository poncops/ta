...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::group(['middleware' => 'isAdmin','prefix' => 'admin', 'as' => 'admin.'], function() {
        ...
        Route::resource('rekenings', \App\Http\Controllers\Admin\RekeningController::class);
        ...
        Route::post('orders/paid/{orderId}', [\App\Http\Controllers\Admin\OrderController::class, 'paid'])->name('orders.paid');
